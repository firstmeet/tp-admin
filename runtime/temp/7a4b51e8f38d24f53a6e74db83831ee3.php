<?php /*a:2:{s:55:"/mnt/d/www/tp/application/user/view/item/type/save.html";i:1556090954;s:47:"/mnt/d/www/tp/application/user/view/layout.html";i:1556090954;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layer-g tpl-g">
    ...
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			<form id="my-form" class="layui-form" method="post" enctype="multipart/form-data">
				<div class="widget-head">
					  <div class="widget-title"><?php if($model['id']): ?>编辑<?php else: ?>新增<?php endif; ?>商品类型
					  </div>
				</div>
				<div class="widget-body layui-col-lg12">
						<div class="layui-form-item">
							<label class="layui-form-label form-require">类型名称 </label>
							<div class="layui-col-sm6 layer-midd-left">
								<input type="text" class="layui-input" name="type[name]" 
									   value="<?php echo htmlentities($model['name']); ?>" required>
							</div>
						</div>
			   
							<input type="hidden" name="type[id]" value="<?php echo isset($model['id']) ? htmlentities($model['id']) : ''; ?>">
